...
export const T: Record<string, Record<string, string>> = {
  ru: {
    ...
    bestLens: "Лучший", coverageLabel: "Покрытие",
  ...
  en: {
    ...
    bestLens: "Best", coverageLabel: "Coverage",
  ...
  zh: {
    ...
    sortModeTitle: "轴优先级",
    modeVPri: "V优先", modeVPriDesc: "先V后H",
    modeVOnly: "仅V", modeVOnlyDesc: "仅V",
    sortModeWhy: "垂直用于弹道修正，更重要。",
    tableCount: "范围内",
    colF: "F",
