...
export const T: Record<string, Record<string, string>> = {
  ru: {
    ...
    heatmapClickHint: "Кликните на ячейку чтобы добавить/убрать фокусное из портфеля",
  ...
  en: {
    ...
    heatmapClickHint: "Click a cell to toggle a focal length in the portfolio",
    tableCount: "in range",
    colF: "F,mm",
  ...
  zh: {
    ...
    heatmapClickHint: "点击单元格以添加/移除组合中的焦距",
    tableCount: "范围内",
    colF: "F",
